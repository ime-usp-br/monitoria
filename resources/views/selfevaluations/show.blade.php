                ...
                <div class="card-body">
                    ...
                    <div class="row custom-form-group">
                        ...
                        <div class="row col-lg">
                            ...
                            <div class="col-lg-auto">
                                {{ $se->schoolclass->department->nomabvset }}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row custom-form-group">
                        <div class="row col-lg">
                            <div class="col-lg-auto pr-0">
                                <label>O trabalho de monitoria foi avaliado como "{{ $se->getWorkloadAsString() }}"{{ $se->workload_reason ? " porque:" : " e não foi apresentada justificativa." }}
                                </label>
                            </div>
